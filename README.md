...
## 2. Compilação e Execução das 5 Versões
...
# Tabelas de Profiling Detalhado por Ferramenta e Versão
...
## 1. Medição de Tempo e Recursos (`/usr/bin/time -v`)
...
## 2. Rastreamento de Chamadas (`gprof` e `cProfile`)
...
## 3. Contadores de Desempenho Físico (`perf stat`)
